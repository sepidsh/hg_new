...
ROOM_CLASS = {"living_room": 1, "kitchen": 2, "bedroom": 3, "bathroom": 4, "balcony": 5, "corridor": 6, "dinning room": 7, "study": 8,
              "studio": 9, "store room": 10,  "graden":11 , "laundry room" :12, "office":13, "basement":14, "garage":15, "undefined":16, "door":17 , "window":18}

CLASS_ROM = {}
for x, y in ROOM_CLASS.items():
    CLASS_ROM[y] = x
import webcolors
ID_COLOR = {1: 'orangered', 2: 'mediumseagreen', 3: 'yellow', 4: 'blue', 5: 'orange', 6: 'purple', 7: 'skyblue', 8: 'magenta', 9:'greenyellow', 10:'salmon', 11: 'darkslategrey', 12: 'plum',13: 'sienna' ,14: 'papayawhip' ,15: 'maroon' ,16: 'lightgreen', 17:'olive' , 18 : 'cornflowerblue' }
