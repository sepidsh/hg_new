    ...
    def __init__(self):
        ...
        self.decoder = nn.Sequential(
            ...
            *conv_block(256, 128, 3, 1, 1, act="leaky"),    
            #*conv_block(128, 128, 3, 1, 1, act="leaky"),
    ...
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            *conv_block(16, 16, 3, 1, 1, act="leaky"),
            #*conv_block(16, 16, 3, 1, 1, act="leaky"),
            *conv_block(16, 16, 3, 1, 1, act="leaky"))
        self.l1 = nn.Sequential(nn.Linear(18, 8 *32 ** 2))
        self.cmp_1 = CMP(in_channels=16)
        ...
        self.decoder = nn.Sequential(
            ...
            *conv_block(128, 128, 3, 2, 1, act="leaky"),#, *conv_block(128, 128, 3, 2, 1, act="leaky"),
            *conv_block(128, 128, 3, 2, 1, act="tanh"))#, *conv_block(128, 128, 3, 2, 1, act="leaky"),
